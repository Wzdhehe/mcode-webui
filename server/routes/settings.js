...
import { getLanBroadcast, setLanBroadcast, getSettingsSnapshot } from '../lib/settings.js'
...
export async function handlePostSettings(req, res, _ctx) {
  ...
  let changed = false
  if (typeof payload.lanBroadcast === 'boolean' && payload.lanBroadcast !== getLanBroadcast()) {
