...
import { MCODE_CMD, DEFAULT_TIMEOUT, DEFAULT_MAX_STEPS, DEFAULT_MODEL } from './config.js'
...
export function runMcodeExec(prompt, opts = {}) {
  const workspace = opts.workspace || (opts.cs && opts.cs.workspace && opts.cs.workspace.dir) || ''
