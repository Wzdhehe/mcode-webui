...
beforeEach(() => {
  ...
  initialSessions = [
    { id: 'webui-A', title: 'A on ws-A', workspace: '/ws-A', createdAt: 1, updatedAt: 1, chat: ['● hi from A'] },
    { id: 'webui-B', title: 'B on ws-B', workspace: '/ws-B', createdAt: 2, updatedAt: 2, chat: ['● hi from B'] },
  ]
...
describe('handleSwitchSession — v0.5.bx-32 lastUsedWorkspace contract', () => {
  ...
  test('switching to the same workspace does NOT write lastUsedWorkspace', async () => {
    ...
    assert.equal(cs.lastUsedWorkspace, 'previous-value',
